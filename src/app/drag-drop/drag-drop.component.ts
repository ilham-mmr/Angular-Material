...
export class DragDropComponent {
  lessons = [
    {
      id: 120,
      description: "Bugfix landing page",
      duration: "4:17",
      seqNo: 1,
      courseId: 11,
    },
    {
      id: 121,
      description: "Implement unit test on components",
      duration: "6:37",
      seqNo: 2,
      courseId: 11,
    },
    {
      id: 121,
      description: "Learn Angular Signal",
      duration: "6:37",
      seqNo: 2,
      courseId: 11,
    },
    {
      id: 121,
      description: "Replace rxjs with Signal",
      duration: "6:37",
      seqNo: 2,
      courseId: 11,
    },
  ...
  inProgress = [];
    ...
    {
      id: 121,
      description: "Create a drag & drop feature",
      duration: "6:37",
      seqNo: 2,
      courseId: 11,
    },
  ...
  dropMultiList(event: CdkDragDrop<Lesson[]>) {
    console.log('----------------')
    console.log("from:", event.previousContainer.id, "(index:", event.previousIndex +')');
    console.log("to:", event.container.id, "(index", event.currentIndex +')');
    console.log('----------------')
